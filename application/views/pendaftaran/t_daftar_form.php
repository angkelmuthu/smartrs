                        ...
                        <form action="<?php echo $action; ?>" method="post">
                            ...
                            <table class='table table-striped'>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo cmb_dinamis('kdpoli', 'm_poli', 'poli', 'kdpoli') ?>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td width='200'>Tglreg <?php echo form_error('tglreg') ?></td>
                                    <td><input type="text" class="form-control" name="tglreg" id="tglreg" placeholder="Tglreg" value="<?php echo $tglreg; ?>" /></td>
                                </tr>
                                <tr>
                                    <td width='200'>Regby <?php echo form_error('regby') ?></td>
                                    <td><input type="text" class="form-control" name="regby" id="regby" placeholder="Regby" value="<?php echo $regby; ?>" /></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
                                        <button type="submit" class="btn btn-warning waves-effect waves-themed"><i class="fal fa-save"></i> <?php echo $button ?></button>
                                        <a href="<?php echo site_url('pendaftaran') ?>" class="btn btn-info waves-effect waves-themed"><i class="fal fa-sign-out"></i> Kembali</a></td>
                                </tr>
                            </table>
                        </form>
                    </div>
