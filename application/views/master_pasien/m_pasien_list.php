            ...
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="row">
                            <div class="col-md-6">
                                <?php echo anchor(site_url('master_pasien/create'), '<i class="fal fa-plus-square" aria-hidden="true"></i> Tambah Data', 'class="btn btn-primary btn-sm waves-effect waves-themed"'); ?>
                                <?php echo anchor(site_url('master_pasien/excel'), '<i class="fal fa-file-excel" aria-hidden="true"></i> Export Ms Excel', 'class="btn btn-outline-success btn-sm waves-effect waves-themed"'); ?>
                                <?php echo anchor(site_url('master_pasien/word'), '<i class="fal fa-file-word" aria-hidden="true"></i> Export Ms Word', 'class="btn btn-outline-primary btn-sm waves-effect waves-themed"'); ?></div>
                            <div class="col-md-6">
                                <form action="<?php echo site_url('master_pasien/index'); ?>" method="get">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center" width="200px">
                                            <?php
                                                ...
                                                echo '  ';
                                                echo
                                                    '<button type="button" class="btn btn-danger btn-xs waves-effect waves-themed" data-toggle="modal" data-target="#default-example-modal-sm' . $master_pasien->nomr . '"><i class="fal fa-trash" aria-hidden="true"></i></button>
    <div class="modal fade" id="default-example-modal-sm' . $master_pasien->nomr . '" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="master_pasien/delete/' . $master_pasien->nomr . '" class="btn btn-primary">Ya, Hapus</a>
            </div>
        </div>
    </div>
</div>';
